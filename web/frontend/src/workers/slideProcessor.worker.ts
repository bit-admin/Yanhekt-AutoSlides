// Ported from autoslides/src/renderer/shared/workers/slideProcessor.worker.ts
 ...
 * multiple concurrent extractions never clobber each other via the shared
 * module-level CONFIG. Falls back to CONFIG when omitted.
 */
