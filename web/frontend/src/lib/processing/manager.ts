 ...
 * Ported from autoslides/src/renderer/shared/processing/manager.ts
 ...
 * started/stopped repeatedly via `run()`. The web has a single playback at a
 * time, but the instanceId plumbing is kept for parity with desktop.
 */
