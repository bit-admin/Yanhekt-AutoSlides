...
describe('courseDisplayTitle', () => {
  ...
  it('keeps the Chinese name in zh/ja/ko', () => {
    for (const loc of ['zh', 'ja', 'ko'] as const) {
      setI18nLanguage(loc)
...
describe('academicTermLabel', () => {
  it('translates the season and keeps the school-year range', () => {
    ...
    setI18nLanguage('ja')
    expect(academicTermLabel('2026-2027', '2')).toBe('2026-2027 春学期')
    setI18nLanguage('ko')
    expect(academicTermLabel('2026-2027', '1')).toBe('2026-2027 가을학기')
  })
