...
export type NavTarget = 'home' | 'live' | 'recorded' | 'search' | 'slides-review' | 'cloud-notes' | 'lectures' | 'settings'
...
const WORKSPACE_TARGETS = new Set<NavTarget>(['slides-review', 'cloud-notes', 'lectures'])
