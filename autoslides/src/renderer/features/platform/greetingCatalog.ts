/**
 * Greeting catalog — pure data consumed by useGreeting.ts.
 * Categories combine a time-of-day bucket with a day-of-week bucket;
 * selection/weighting logic lives in useGreeting.ts.
 */
...
export type GreetingLanguage = 'en' | 'zh' | 'ja' | 'ko'
...
export const GREETING_CATALOG: Greeting[] = [
  // ── General / EN ─────────────────────────────────────────────────
  ...
  { id: 'zh_moonlit',             text: '今夜月色真美',                   language: 'zh', requiresName: false, category: 'night',     weight: 5 },
