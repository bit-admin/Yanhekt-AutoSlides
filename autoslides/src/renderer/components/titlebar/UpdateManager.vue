<template>
  <!-- Update Modal -->
  <div v-if="showUpdateModal" class="modal-overlay installer-modal-overlay" @click="closeUpdateModal">
    <div class="modal-content installer-modal update-modal" @click.stop>
...
/* Shared installer/update chrome lives in shared/styles/installerModal.css
   (namespaced under .installer-modal). Only update-specific extras here. */
.current-version {
  font-size: 12px;
