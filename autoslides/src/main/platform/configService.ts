...
export class ConfigService {
  ...
  getConfig(): AppConfig {
    return {
      ...
      resumeFromServerProgress: this.store.get('resumeFromServerProgress') ?? true,
      resumeFromServerProgressLectures: this.store.get('resumeFromServerProgressLectures') ?? true,
