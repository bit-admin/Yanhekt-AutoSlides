 ...
 * Editor.js documents). Shared by the export, import, and share flows so the
 * image-block parsing + managed-metadata handling live in exactly one place.
 * Imported via `@common/notesContent`.
 */
