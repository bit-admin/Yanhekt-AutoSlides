 ...
 *
 * Everything here is pure so it can be unit-tested without Electron, Vue or the
 * network; the effectful half lives in `renderer/shared/services/watchProgressService.ts`.
 */
